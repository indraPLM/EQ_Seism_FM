...
if (len(x1)== 0 and len(x2) ==0):
    folium.Marker(location=[y0,x0], icon=folium.Icon(icon="cloud",prefix='fa', color='red'),).add_to(m)
...
if (len(x1)== 1 and len(x2)==1):
    ...
    y2=str(y2[0])
    folium.Marker(location=[ y0,x0], icon=folium.Icon(icon="cloud",prefix='fa',color='red'),).add_to(m)
    folium.Marker(location=[y1,x1], icon=folium.Icon(icon="info-sign",prefix='fa',color='blue'),).add_to(m)
    folium.Marker(location=[y2,x2], icon=folium.Icon(icon="circle",prefix='fa',color='green'),).add_to(m)
